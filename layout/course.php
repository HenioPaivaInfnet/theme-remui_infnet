...
echo $OUTPUT->render_from_template('theme_remui_infnet/course', $templatecontext);
$PAGE->requires->js( new moodle_url($CFG->wwwroot . '/theme/remui_infnet/javascript/course.js'));
